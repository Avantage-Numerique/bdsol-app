...
const Documentation = ({ documentation }) => {
    ...
    const schema = {
        ...
        description:
            "Documentation complète sur l'ontologie utilisée dans la base de donnée ouverte et liée d'Avantage Numérique.",
        ...
        about: {
            ...
            "@type": "Dataset",
            description:
                "Ontologie d'Avantage Numérique destinée à être utilitée dans une base de données ouverte et liée, dans le but de regrouper les techno-créatifs présents sur le territoire du Croissant boréal.",
            name: "Ontologie - Avantage Numérique",
            creator: {
                "@context": "http://schema.org",
                "@type": "Organization",
        ...
        */}
            ...
            <header className="bg-blue2">
                <section className="text-white col-12">
                    <h1>
                        Préparez vos données pour vous connecter au <br />
                        <span className="text-dark">Croissant boréal</span>
                    </h1>
