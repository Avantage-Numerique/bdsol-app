...
const Help = () => {
    return (
        <div className={`col-12 ${styles["help-menu"]}`}>
            ...
            <div>
                Un bouton nommé "<u>Partage d'idée</u>" se trouve sur la droite de votre écran. Il permet de prendre en image une partie de votre écran 
            ...
            <div>
                ...
                <h4>Dans la barre, au haut de l'écran :</h4>
                <ul>
                    ...
                    <li>- Totalement à droite, le bouton fait de <u>3 lignes horizontales</u> vous montre un menu qui facilitera la navigation vers les autres pages.</li>
                </ul>
                <br></br>
                <h4>À la droite de ce texte, la section Menu du compte</h4>
                <ul>
                    ...
                    <li>- "<u>Historique de modification</u>" : affichera les modifications que vous avez apportée à la base de données (Les ajouts, modifications ou suppression)</li><br></br>
