        ...
        <div className={"home-page"}>
                    ...
                    <div className="d-flex flex-column align-items-center">
                        ...
                        <div className="home-page__feed-section container py-4 position-relative">
                            ...
                            {isLoading && (
                                <div className={"home-page__feed-section--spinner-container"}>
                                    ...
                                    <p className="text-center">
                                        <strong>{lang.loadingData}</strong>
                                    </p>
                                </div>
                            )}
                            ...
                            {feedList.length > 0 && !isLoading && (
                                <EntitiesGrid
                                    className={
                                        "row home-page__feed-section--container row-cols-1 row-cols-sm-2 row-cols-xl-3"
                                    }
                                    columnClass={"col-12 col-sm-6 col-md-4 g-4"}
                                    feed={feedList}
                ...
                <div className="container">
                    <div className="row justify-content-around home-page__section-inner-y-padding">
                        <div
                            ...
                            className="position-relative flex-grow-1 col-12 col-md-6 col-lg-4 order-2 order-md-1 p-2"
                        >
                            <Image
                                className="position-absolute w-100 h-100 object-fit-cover top-0 start-0"
                                priority={false}
                                src={organizationPresentationImg}
                                alt="Présentation de l'organisation"
                            />
                        </div>
                        <div
                            style={{ maxWidth: "60ch" }}
            ...
            <section className="home-page__full-width-section position-relative my-4">
                <figure className="position-absolute top-0 bottom-0 start-0 end-0">
                    <Image
                        className="h-75 d-none d-md-block w-auto position-absolute end-0 top-0"
                        src={shipAndPlanetsImg}
                        alt="Fusée d'AVNU se déplaçant entre les planètes dans l'espace."
                    />
                </figure>
