                ...
                <section id="faq-licence-accronymes" className={"row pb-3"}>
                    <div className={"col"}>
                        ...
                        <ul>
                            <li>
                                <h4>
                                    <InPageLink name={"domaine-public"} />
                                    {
                        ...
                        <blockquote className={"mt-5 bg-primary-lighter"}>
                            Sources : &nbsp;
                            <ExternalLink
