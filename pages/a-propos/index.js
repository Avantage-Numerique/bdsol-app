    ...
    return (
        <div className={"page-apropos"}>
            ...
            <Container className={"home-page__main"}>
                <Row>
                    <h3 className="col-12">Un projet en développement</h3>
                    <p className="fs-4">
                ...
                <Row>
                    <h3 className="col-12">Quelles sont les caractéristiques de cette base de données ?</h3>
                    <p className="fs-4">
                        Les données sont <strong>structurées :</strong> elles sont prédéfinies et formatées selon une structure précise, et ce dans le but d’être compréhensible par les ordinateurs.<br/>
                        Les données sont <strong>ouvertes :</strong> elles sont accessibles et, suivant la politique de gestion de données établie, elles peuvent être utilisées librement par les usager·ères.<br/>
                ...
                <Row>
                    <h3 className="col-12">À quoi va servir la base de données ?</h3>
                    <p className="fs-4">
                        Une fois mise en place, la base de données pourra être parcourue librement par les utilisateur·trices souhaitant se renseigner sur les ressources technologiques proposées dans le Croissant Boréal. Elle permettra par exemple de :<br/>
                            <strong>Trouver une personne ayant les compétences</strong> dans un domaine, dans une technologie ou avec un équipement, afin de réaliser un projet technocréatif.<br/>
                            <strong>Se renseigner sur les espaces et les équipements</strong> permettant de réaliser un projet précis.<br/>
                            <strong>Découvrir les compétences nécessaires</strong> pour accomplir un type de projet ou pour l’utilisation d’un équipement.<br/>
                            <strong>Partager des solutions</strong> et des marches à suivre pour répondre à des problèmes techniques.<br/>
                            <strong>Améliorer la
                                &nbsp;
                                <u>
                            ...
                            d’un projet ou d’un organisme.<br/>
                            <strong>Promouvoir</strong> des œuvres, des formations, des travaux, des projets et des organisations.
                    </p>
                </Row>
                <Row>
                    <h3 className="col-12">Qui pourra utiliser la base de données ?</h3>
                    <p className="fs-4">La base de données est destinée à un public large comprenant autant les professionnel·les du numérique que les personnes en quête d’apprentissage. Elle sera libre d’accès pour tous·tes les usager·ères souhaitant en apprendre davantage sur les ressources technologiques du Croissant Boréal.</p>
                </Row>
                <Row>
                    <h3 className="col-12">Formulaire d’intégration de données à la version bêta de la base de données</h3>
                    <p className="fs-4">Bien que la base de données soit pour l’instant inaccessible publiquement, il sera bientôt possible d’intégrer à sa version bêta des informations grâce à un formulaire. Les renseignements collectés seront ainsi ajoutés à la base de données et directement exploitables lorsque cette dernière sera mise en ligne. Il sera possible par la suite de les modifier et de les compléter.</p>
                    <h3 className="col-12">Utilisation et gouvernance des données</h3>
                    <p className="fs-4">L’équipe travaille actuellement sur l’établissement d’une gouvernance des données. Toute information entrée dans le formulaire sera sous la licence CC0
                        &nbsp;
                        (<u>
