    ...
    const submitHandler = async (event) => {
        ...
        */
        ...
        if (!isNewFile) {
            ...
            await submitRequest("/medias/update", "POST", formData);
        }
    };
                ...
                <div className="row w-100 gx-3">
                    ...
                    >
                        ...
                        {!isNewFile && (
                            <button
                                type="button"
                                onClick={convertToNewImageMode}
                                className="mb-0 mt-1 fs-6 text-primary"
                            >
                        ...
                        >
                            ...
                            <div className="row">
                                <button
                                    ...
                                    className={`${styles["form-inner-nav__button"]} col fs-6`}
                                    type="button"
