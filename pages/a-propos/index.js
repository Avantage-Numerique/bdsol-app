                ...
                <div className={"row py-4"}>
                    <div className={"col"}>
                        ...
                        <p className={pClass}>
                            ...
                            objectif de transmission des savoirs et d’apprentissage collectif, cette{" "}
                            <strong>base de données ouvertes</strong> se veut être un outil pour répertorier les
                            activités technocréatives locales.
                            <br />
                            <br />
                            Que vous soyez un·e professionnel·le du numérique ou simplement un·e curieux·se des
                            nouvelles technologies, ce portail en ligne vous permettra de géolocaliser les{" "}
                            <strong>organisations</strong>, les <strong>équipements</strong>, les{" "}
                            <strong>projets</strong>, les <strong>ressources humaines</strong> et les{" "}
                            <strong>événements</strong> qui vous aideront à réaliser votre projet technocréatif.
                        </p>
                    </div>
                </div>
                <div className={"row py-4"}>
                    <div className={"col"}>
                        ...
                        <ul>
                            <li className={`${styles["page-list"]}`}>
                                <RouteLink routeName="consult" label="Consulter et trier les données" /> déjà existantes
                                sur la plateforme (personnes, organisations, équipements, événements et projets)
                            </li>
                            <li className={`${styles["page-list"]}`}>
                                Vous <RouteLink routeName="register" label="créer un compte" /> ou vous{" "}
                                <RouteLink routeName="connection" label="connecter" /> pour pouvoir à votre tour ajouter
                    ...
                    <div className={"col"}>
                        ...
                        <ul>
                            <li className={`${styles["page-list"]}`}>
                                ...
                                technologie ou avec un équipement, afin de réaliser un projet technocréatif.
                            </li>
                            <li className={`${styles["page-list"]}`}>
                                <strong>Se renseigner sur les espaces et les équipements</strong> permettant de réaliser
                                un projet précis.
                            </li>
                            <li className={`${styles["page-list"]}`}>
                                <strong>Découvrir les compétences nécessaires</strong> pour accomplir un type de projet
                                ou pour l’utilisation d’un équipement.
                            </li>
                            <li className={`${styles["page-list"]}`}>
                            ...
                            <li className={`${styles["page-list"]}`}>
                                <strong>Promouvoir</strong> des œuvres, des formations, des travaux, des projets et des
                                organisations.
                            </li>
                        </ul>
                    </div>
                ...
                <div id="gouvernance-des-donnees" className={"row py-4"}>
                    <div className={"col"}>
                        ...
                        <p>
                            ...
                            possibilité d’ajouter de nouvelles données et de modifier celles déjà présentes sur la
                            plateforme. La manière dont nous gérons les données est décrite en détail dans notre{" "}
                ...
                <div className={"row py-4"}>
                    <div className={"col"}>
                        ...
                        <p>
                            ...
                            <RouteLink routeName={"valuesChart"} /> qui guide l’ensemble des actions réalisées dans un
                            esprit de codéveloppement et d’innovation ouverte.
                        </p>
                    </div>
                </div>
                        ...
                        <div className={"col py-4"}>
                            ...
                            <ul>
                                <li>
                                    ...
                                    <p className={pClass}>
                                        &mdash; Production et architecture technique de l’application et de la base de
                                        données
                                    </p>
                                </li>
                                <li>
