            ...
            <div className="container position-relative">
                ...
                <div className={`row justify-content-center ${styles["secondary-logo--container"]}`}>
                    <div className="d-flex justify-content-center ">
                        <a href="https://avantagenumerique.org/?ref=avnuca" title={"Site web d'avantage numérique"}
                           rel={"nofollow"}>
                ...
                <div className={`row`}>
                    <div className={`${styles.socialMediaLogos} d-flex justify-content-center`}>
                        <div className={`${styles.FacebookLogo} ${styles.socialMediaLogo}`} role="img"
                             aria-label="Logo Facebook"><a href="https://www.facebook.com/avantagenumerique/">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 394.48 394.48">
                                <path
                                    ...
                                    fill="#1F1F2E"/>
                                <path className={`${styles.colorTransition}`}
                                      d="M256.55,162v35.28h54.72l-7.13,55.26H256.55V385.4a196.49,196.49,0,0,1-51.46,8.93h-5.6V252.54H151.78V197.28h47.71V156.53c0-47.29,28.88-73,71.07-73a392.06,392.06,0,0,1,42.64,2.18v49.42H283.94C261,135.1,256.55,146,256.55,162Z"
                                      fill="#212121"/>
                            </svg>
                        </a></div>
                        <div className={`${styles.InstagramLogo} ${styles.socialMediaLogo}`} role="img"
                             aria-label="Logo Instagram"><a href="https://www.instagram.com/avantagenumerique/">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 394.48 394.48">
                        ...
                        <div className={`${styles.YoutubeLogo} ${styles.socialMediaLogo}`} role="img"
                             aria-label="Logo Youtube"><a
                            href="https://www.youtube.com/channel/UCZ43sUJzg1_4CI1msKiTaLw?view_as=subscriber">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 394.48 394.48">
                                <circle cx="197.24" cy="197.24" r="197.24" fill="#1F1F2E"/>
                                <path className={`${styles.colorTransition}`}
                ...
                <div className={`row d-flex flex-column py-4`}>
                    <p className="text-center my-0"><small>Contact
                        : {appConfig.legal.email}, {appConfig.legal.address}</small></p>
                </div>
            </div>
