export const base = {
    ...
    fetchErrorMessage:
        "Une erreur est survenue et le serveur ne semble pas répondre. Assurez-vous d'avoir une connexion internet.",

    //  Forms

    formNotValid:
        "Attention. Le formulaire envoyé est invalide. Assurez-vous que tous les champs requis sont bien remplis.",
    submit: "Soumettre",
    ...
    // Footer
    footer__catchphrase:
        "AVNU est une base de données collaborative qui regroupe les personnes technocréatives des francophonies nord-canadiennes et du Croissant boréal (Nord de l’Ontario, Abitibi-Témiscamingue et Baie-James).",
};
