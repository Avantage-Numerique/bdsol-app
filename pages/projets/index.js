    ...
    */
    const fetchData = async () => {
        ...
        if (!response.error) {
            ...
            msg.addMessage({
                text: "Une erreur est survenue et nous n'arrivons pas à afficher les fiches de projets. Veuillez réessayer.",
                positive: false,
            });
        }
    };
            ...
            <div className="container">
                <div className="row my-4 py-4">
                    ...
                    <section className="col col-12 col-md-9">
                        ...
                        {projectList.length > 0 && !isLoading && (
                            <EntitiesGrid
                                className="position-relative row row-cols-1 row-cols-sm-2 row-cols-xl-3"
                                feed={projectList}
                            />
                        )}
                    </section>
