...
import organizationPresentationImg from "@/public/general_images/fusee-planetes-pointilles2-90deg.svg";
                        ...
                        <div className="col">
                            ...
                            <section className={`${styles["nav-section"]}`}>
                                ...
                                <ul className={`${styles["button-list"]}`}>
                                    ...
                                    <li>
                                        <MainNavButton
                                            route={AppRoutes.equipmentCreate}
                        ...
                        <div className="col">
                            <section className={`${styles["nav-section"]}`}>
                                ...
                                <ul className={`${styles["button-list"]}`}>
                                    ...
                                    <li>
                                        <MainNavButton route={AppRoutes.compatibility} handler={navLinkHandler} />
                                    </li>
                                    <li>
                                        <MainNavButton
                                            route={AppRoutes.about}
