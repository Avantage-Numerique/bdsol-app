...
export const pageMeta = {
    ...
    /* /equipement */
    equipment__descrption:
        "Les équipements répertoriés dans la base de données peuvent être associés à différents types d'entités, tels que des personnes ou des organisations.",

    /* /Event */
    event__description:
        "Gérés par des organisations, les événements sur AVNU se distinguent par leur nature numérique.",

    /* /organisations */
    organisations__description:
        "Les organisations répertoriées travaillent avec les technologies numériques et sont situées dans la région du Croissant boréal.",
