...
const HomePage = (props) => {
    ...
    const headerDescription = () => {
        return (
            <div>
                <ExternalLink href={"https://fr.wikipedia.org/wiki/Projet:Croissant_bor%C3%A9al"}>Le projet du croissant boraél sur Wikipédia</ExternalLink>
                <ExternalLink href={"https://avantagenumerique.org/le-croissant-boreal/"}>La page dédier au territoire sur le site web d'Avantage Numérique</ExternalLink>
            </div>
        )
    }
            ...
            <section className="container py-4">
                ...
                <div className="row">
                    <div className="col-12 col-md-6">
                        ...
                        <p>Le Nord de l’Ontario francophone, l’Abitibi-Témiscamingue et le Nord-du-Québec ont de nombreux points communs en matière de territoire, d’économie, d’identité et de culture. En nous unissant, nous augmentons notre pouvoir d’action et favorisons notre déploiement à l’échelle nationale et internationale et au sein de la francophonie.</p>
                    </div>
                    <div className="col-12 col-md-6">
                        <h2>Le projet d'AVNU est né <br/>dans le croissant boréal</h2>
                        <p>Nous avons commencé à ajouter des badges pour identifier chacun des technocréatifs dans les territoires d'AVNU. Le premier est pour le croissant Boréal.</p>
                        <ul>
                        {badgeCroissantBoreal &&
                            <li key={`badge-CB`} className={"list-group-item p-0 position-relative"}>
                                <img className="" width="40px" height="40px" src={badgeCroissantBoreal.iconPath} alt={badgeCroissantBoreal.iconAlt}/>
                                <span>{badgeCroissantBoreal?.label ?? "Badge"}</span>
                                <span className={"badge bg-secondary ms-2"}>{badgeCroissantBoreal.description}</span>
                            </li>
                        }
                        </ul>
                    </div>
