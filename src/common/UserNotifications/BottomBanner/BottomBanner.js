...
export default function BottomBanner(props) {
    const { title, bannerButtons, children, Thumb, onCloseCallback } = props;
    ...
    return (
        <>
            ...
            {displayState && (
                <dialog
                    open
                    className={`bg-primary-lighter ${fadeOutClass && styles["close"]} ${styles["bottom-banner"]}`}
                >
                    <div className="container">
                        <div className={"row"}>
                            {Thumb && (
                                <div
                                    className={`col-md-${thumbColWidth} d-flex justify-content-center align-items-center`}
                                >
                                    <Thumb />
                                </div>
                            )}
