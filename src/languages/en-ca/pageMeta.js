...
const pageMeta = {
    ...
    categories__description:
        "Explore the various categories used to classify our data: domains, technologies, skills, equipment types.",

    /* /charte-de-valeurs */
    charterOfValues__title: "Charter of Values - AVNU",
    charterOfValues__description:
        "Explore our Charter of Values, an ever-evolving and essential guide for the proper functioning of the Platform.",
    ...
    compte__description:
        "Explore your member space: track the history of your modifications, update your personal information, or get navigation tips.",

    /* /consulter */
    consult__title: "Consult the data",
    consult__description:
        "Explore the various entities listed in the territory of the Boreal crescent: individuals, organizations, projects, events, and facilities.",

    /* /contribuer */
    contribute__title: "Contribute to the database",
    contribute__description:
        "Choose the type that best corresponds to the data you want to enter, then add it in just a few clicks.",
    ...
    organisations__description:
        "The listed organizations work with digital technologies and are located in the Boreal crescent region.",

    /* /persons */
    persons__description:
        "Persons can be digital creators, experts, equipment owners, promoters, and anyone keen to contribute to digital tech in the Croissant boréal.",
    ...
    privacy_policy__description:
        "Explore our Privacy Policy: commitments, practices, and governance to protect your personal information.",
