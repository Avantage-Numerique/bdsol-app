...
const SearchResults = (props) => {
    ...
    const getIdRouteResponse = (linkId) => {
        return clientSideExternalApiRequest("/search/" + linkId, {
            method: "GET",
        });
    };
            ...
            <div className="py-4">
                {showLinkedTaxonomy &&
                    (nearTaxonomyObject?.nearestTaxonomy ? (
                        <h3>
                            Entité reliée à la catégorie :
                            {
                                <a
                                    href={`/categories/${nearTaxonomyObject?.nearestTaxonomy?.category}/${nearTaxonomyObject?.nearestTaxonomy?.slug}`}
                                >
                                    &nbsp;
            ...
            <div>
                ...
                {!isLoading && (
                    <div className="row py-4">
                        ...
                        <div
                            className={`col ${nearTaxonomyObject?.otherNearbyTaxonomy?.length > 0 ? "col-md-9" : "col-md-12"}`}
                        >
