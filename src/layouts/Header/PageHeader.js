        ...
        >
            <div className="container">
                ...
                >
                    ...
                    <div
                        className={`${!props.colFullWidth && styles["header-left-col--max-width"]} ${styles["stacking-context-front"]} ${props.leftColClassName} col-12 col-md-${colNumberXs} d-flex flex-column justify-content-center position-relative`}
                    >
                        {historyBack && (
